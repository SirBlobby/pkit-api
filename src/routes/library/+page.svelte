...
<div class="container mx-auto p-2 sm:p-4"> 
    <div class="text-center mb-6 sm:mb-8">
        <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-surface-900 dark:text-surface-100 mb-2">Library</h1>
        <p class="text-lg sm:text-xl text-surface-700 dark:text-surface-300 mb-2">Programmer Kit Library</p>
